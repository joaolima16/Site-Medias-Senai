...
function novo_aluno(){
    ...
    const caminho_situacao = document.querySelector("#situacoes");
    ...
    const div_notas = criar_elemento('div','',`aluno${num_alunos + 1}`,'col-md-12','','');
    ...
    const situacao_aluno = criar_elemento("p", "",`situacao_aluno${num_alunos+1}`,'','',`Situação ${num_alunos+1}`);
...
function apaga_aluno(){
    ...
    const caminho_guarda_situacoes = document.querySelector("#situacoes");
